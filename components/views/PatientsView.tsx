...
const patients = [
  {
    id: "00482-A", name: "Baby R.", age: "6 mo", weight: "7.2 kg", sex: "F",
    day: 3, status: "ALERTING", events: 21, iess: 7.2, clinician: "Dr. K. Arora",
    etiology: "HIE", lastEvent: "14:19", ward: "3B-04",
  },
  {
    ...
    <div className="p-6 space-y-5 max-w-[1600px]">
      ...
      <div className="grid grid-cols-4 gap-4">
        {[
          ...
          { label: "Total Events", value: "32", sub: "Today across ward", color: "var(--amber)" },
          { label: "Avg IESS", value: "4.4", sub: "Ward severity index", color: "var(--teal)" },
        ].map((s) => (
            ...
            {patients.map((p, i) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-5 py-3.5">
                    <span className="metric text-base" style={{ color: p.iess >= 6 ? "var(--red)" : p.iess >= 4 ? "var(--amber)" : "var(--teal)" }}>
                      {p.iess}
                    </span>
